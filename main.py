...
st.markdown("Q7. 5번 학생의 등수는? \nRANK.EQ 함수로 계산했을 때 등수는?(단위를 생략해주세요.)")

q7 = st.text_input("등수를 구하는 함수 예: RANK.EQ(B5, $B$2:$B$34, 0)", key="q7")

if q7:
    if q7.strip() == "14":
        st.success("정답! 5번 학생의 등수는 14등입니다.")
    else:
        st.error("아쉽습니다! 정답은 14등입니다. (87점 동점자 포함)")
